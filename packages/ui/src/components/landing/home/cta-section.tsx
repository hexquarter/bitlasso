    ...
    <section id="cta" className="relative border-t border-border/40 px-6 py-36 sm:px-10 md:py-48 lg:px-16">
      ...
      <div ref={ref} className="relative z-10 mx-auto max-w-[90rem]">
        <div className="flex flex-col items-center text-center">
          <h2
            className={`max-w-4xl font-serif text-[clamp(2.6rem,5vw,5.5rem)] font-normal leading-[0.95] tracking-[-0.02em] text-foreground transition-all duration-1000 ${isInView ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
          >
